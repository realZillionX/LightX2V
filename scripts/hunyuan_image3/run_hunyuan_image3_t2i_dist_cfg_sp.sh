...
# Set paths first. This generic CFG+SP example uses the Ulysses config.
...
torchrun --standalone --nproc_per_node=4 -m lightx2v.infer \
    ...
    --save_result_path "${lightx2v_path}/save_results/hunyuan_image3_t2i_cfg2_ulysses_sp2.png" \
    --seed 42
