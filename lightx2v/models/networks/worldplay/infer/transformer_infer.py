...
class WorldPlayTransformerInfer(HunyuanVideo15TransformerInfer):
    """
    Transformer inference for WorldPlay model.
    ...
    def _infer_img_branch_before_attn(self, weights, infer_module_out):
        """
        Override to handle per-token vec modulation for WorldPlay.
