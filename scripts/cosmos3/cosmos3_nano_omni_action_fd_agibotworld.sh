...
--config_json ${lightx2v_path}/configs/cosmos3/cosmos3_nano_omni_action_fd_agibotworld.json \
--prompt "" \
--image_path ${image_path} \
--action_path ${action_path} \
--save_result_path ${lightx2v_path}/save_results/cosmos3_nano_action_fd_agibotworld.mp4 \
--seed 0
