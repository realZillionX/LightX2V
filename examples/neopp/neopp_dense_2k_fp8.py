...
pipe.generate(
    task="t2i",
    seed=200,
    save_result_path="/path/to/save_results/output_lightx2v_neopp_dense_2k_fp8_0.png",
...
pipe.generate(
    task="t2i",
    seed=201,
    save_result_path="/path/to/save_results/output_lightx2v_neopp_dense_2k_fp8_1.png",
    size=[2048, 2048],  # Height, Width
)
...
pipe.generate(
    task="t2i",
    seed=202,
    save_result_path="/path/to/save_results/output_lightx2v_neopp_dense_2k_fp8_2.png",
    size=[2048, 2048],  # Height, Width
)
