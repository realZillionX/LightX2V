...
--config_json ${lightx2v_path}/configs/cosmos3/cosmos3_super_omni_action_fd_agibotworld_multichunk.json \
--prompt "" \
--image_path ${image_path} \
--action_path ${action_path} \
--save_result_path ${lightx2v_path}/save_results/cosmos3_super_action_fd_agibotworld_multichunk.mp4 \
--seed 0
