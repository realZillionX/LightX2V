...
config_template=${CONFIG_JSON:-${lightx2v_path}/configs/platforms/intel_xpu/dist_infer/minimax_h3_t2av_dmd_lora_4step_sp_tp.json}
output_path=${OUTPUT_PATH:-${lightx2v_path}/save_results/output_lightx2v_minimax_h3_t2av_dmd_lora_4step_sp2_tp2.mp4}
...
runtime_config=$(mktemp "${TMPDIR:-/tmp}/lightx2v-minimax-h3-xpu-sp-tp-XXXXXX.json")
