...
class WanMtxg2PreWeights(WeightModule):
    def __init__(self, config):
        ...
        self.add_module(
            "img_emb_0",
            LN_WEIGHT_REGISTER[config.get("layer_norm_type", "torch")]("img_emb.proj.0.weight", "img_emb.proj.0.bias", eps=1e-5),
        )
        self.add_module(
            "img_emb_1",
        ...
        self.add_module(
            "img_emb_4",
            LN_WEIGHT_REGISTER[config.get("layer_norm_type", "torch")]("img_emb.proj.4.weight", "img_emb.proj.4.bias", eps=1e-5),
        )
